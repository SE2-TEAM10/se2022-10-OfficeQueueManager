...
class ServiceListElement extends StatefulWidget {
  ...
  @override
  State<ServiceListElement> createState() => _ServiceListElementState();
}

class _ServiceListElementState extends State<ServiceListElement> {
  bool hover = false;
